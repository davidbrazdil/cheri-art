...
rm -f ${SYSROOT_DIR}/lib/clang/3.4/include/std*
...
echo make ${JFLAG} ${FBSD_BUILD_ARGS} -DNOCLEAN buildworld
try_to_run make ${JFLAG} ${FBSD_BUILD_ARGS} -DNOCLEAN buildworld
